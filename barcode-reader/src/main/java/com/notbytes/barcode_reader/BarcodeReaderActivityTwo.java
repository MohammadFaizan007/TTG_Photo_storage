...
public class BarcodeReaderActivityTwo extends AppCompatActivity implements BarcodeReaderFragment.BarcodeReaderListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_barcode_reader_two);
    ...
    public static Intent getLaunchIntent(Context context, boolean autoFocus, boolean useFlash) {
        Intent intent = new Intent(context, BarcodeReaderActivityTwo.class);
