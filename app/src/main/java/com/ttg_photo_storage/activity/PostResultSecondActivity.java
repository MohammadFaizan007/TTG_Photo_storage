...
public class PostResultSecondActivity extends BaseActivity {
...
//        assedId.setText("AssetID  :  " + uid);
    ...
    private void getPost() {
        try {
            showLoading();
            Call<UIdResponse>resultCall = apiServices.post("getpost",uid,PreferencesManager.getInstance(context).getToken(), Integer.valueOf("2"));
            resultCall.enqueue(new Callback<UIdResponse>() {
                ...
                public void onResponse(Call<UIdResponse> call, Response<UIdResponse> response) {
                    ...
                    if (response.body().getStatus().equalsIgnoreCase("success")){
                        ...
                        PostResultAdapter adapter = new PostResultAdapter(context,list, PostResultSecondActivity.this);
